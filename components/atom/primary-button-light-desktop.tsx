	...
	return (
		<button className="group flex items-center justify-between w-fit gap-4 h-fit rounded pl-[18px] pr-[10px] py-[10px] cursor-pointer bg-floral-white overflow-hidden">
			...
			<div className="relative h-fit overflow-hidden flex items-center">
				{/* Default text */}
				<span className="block text-sm text-charcoal font-aeonik-medium transform transition-transform duration-300 ease-out group-hover:-translate-y-[140%]">
					{text}
				</span>

				{/* Duplicate text (slides up on hover, with spacing offset) */}
				<span className="absolute left-0 top-[140%] block text-sm text-charcoal font-aeonik-medium transform transition-transform duration-300 ease-out group-hover:translate-y-[-140%]">
					{text}
				</span>
			</div>
...
export default PrimaryButtonLightDesktop;
